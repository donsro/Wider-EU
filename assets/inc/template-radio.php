...
<body>
<section class="main-section"> <header> <section class="row hero-unit"> 
...
<div class="row"> 
  <div class="medium-9 columns"> <section class="topics"> <?php printArticles($sitemap[$current]["submenu"]); ?> 
    </section> </div>
